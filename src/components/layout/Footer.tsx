...
const DEFAULT_FOOTER = {
  logoText: 'TechFlow',
  companyDescription:
    'Empowering startups and enterprises with cutting-edge web development solutions. Join thousands of developers who trust our modern platform to build the future.',
  contactEmail: 'hello@techflow.dev',
  contactPhone: '+1 (555) 123-TECH',
  ...
  linkWebinars: 'Tech Webinars',
  linkWebinarsHref: '/webinars',
  linkCaseStudies: 'Success Stories',
